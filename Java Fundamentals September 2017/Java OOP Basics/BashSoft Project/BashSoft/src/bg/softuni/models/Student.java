...
public class Student {
    ...
    public void setMarkOnCourse (String courseName, int... scores){
        ...
        if (scores.length > Course.NUMBER_OF_TASKS_ON_EXAMS) {
    ...
    private double calculateMark(int[] scores){
        double percentageOfSolvedExams = Arrays.stream(scores).sum() / (double) (Course.NUMBER_OF_TASKS_ON_EXAMS * Course.MAX_SCORE_ON_EXAM_TASK);
